...
class MisReservasController extends Controller
{
    ...
    public function create()
    {
        ...
        $salas = salas::all();
        return view('mis_reservas.create', compact('salas'));
    }
    ...
    public function store(reservasRequest $request)
    {
        ...
        return redirect('admin/reservas/'.$reservas->usuario_id)->with('message','La Reserva se creo Correctamente');
    }
    ...
    public function edit($id)
    {
       $sala = \DB::table('reservas_salas')
        ...
        //dd($reservas);
        return view('mis_reservas.edit', compact('salas', 'sala'))->with('reservas',$reservas);;
    }
    ...
    public function update(reservasRequest $request, $id)
    {
        ...
        $reservas->hora_final = $request->input('hora_final');
        $reservas->save();
        return redirect('admin/reservas/'.$reservas->usuario_id)->with('message','La Reserva se edito Correctamente');
    }
    ...
    public function destroy($id)
    {
        $reservas = reservas_salas::find($id);
        $reservas->delete();
         return redirect('admin/reservas/'.$reservas->usuario_id)->with('message','La Reserva se Elimino Correctamente');
    }
}
